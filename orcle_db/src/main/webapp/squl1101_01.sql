...
b.department_id, b.department_name, b.parent_id, b.manager_id, b.create_date, b.update_date
...
--David Austin 이 사람이 속한 부서(60)의 사람들을 출력하느데, 부서명도 출력하시오.
--사원번호,사원명,월급,부서번호,부서명,부서입력일(create_date),부서수정일(update_date),직급번호
...
--직급별 최소 월급이 5000 이상인 직급의 사람들 중 부서번호가 50번이상인 사람들만 출력하시오.
...
select employee_id,emp_name,job_id,a.department_id,d.department_name
...
--STUNUM,NAME,학년GRADE,TOTAL,AVG,GRADE 출력하시오.
select grade from stuinfo;

select a.stunum,total,avg,c.grade "학년", b.grade "성적"
...
--매니저 이름이 Steven King인 사원을 모두 출력하시오.
--employee_id,emp_name,manager_id,emp_name,부서번호,부서명,직급타이틀(job_title)
select a.employee_id,a.emp_name,a.manager_id,b.emp_name,a.department_id,c.department_name,job_title
